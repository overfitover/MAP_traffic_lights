...
"""
def voc_ap(rec, prec):          # 输入召回率以及准确率的list, 返回 ap, 召回率，准确率
  """
...
"""
 Convert the lines of a file to a list   将文件的每一行转换成list
"""
...
"""
 Create a "tmp_files/" and "results/" directory   新建tem_file  results文件夹,在results里新建classes和images文件夹
"""
...
"""
 Ground-Truth
   ...
   Create a list of all the class names present in the ground-truth (gt_classes).  加载所有的gt file 转换成临时文件 .json 文件
"""
...
for txt_file in ground_truth_files_list:
  ...
  file_id = os.path.basename(os.path.normpath(file_id))   # 返回文件名 00000
